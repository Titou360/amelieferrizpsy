  ...
  return (
    ...
    >
      ...
      <div className="relative z-20 text-center px-4 sm:px-6 max-w-4xl mx-auto">
        ...
        <p
          ref={subtitleRef}
          className="font-sans text-base sm:text-lg text-cream/90 leading-relaxed max-w-xl mx-auto mb-12"
        >
          Je vous accompagne dans votre cheminement intérieur avec bienveillance
          et professionnalisme, au cabinet à Narbonne, à domicile ou en
          téléconsultation.
        </p>
